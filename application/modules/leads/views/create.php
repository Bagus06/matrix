...
<form method="post" action="" enctype="multipart/form-data">
    <div class="col-12 p-0 m-0 row">
        <div class="col-12 col-md-12 col-xl-7">
            ...
            <div class="card">
                ...
                <div id="more_information" class="collapse show" data-parent="#more_information">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label class="pb-0 mb-0" id="lbl-religion">Religion</label>
                            <select class="form-control bg-transparant w-100" title="Select university for course" name="religion">
            ...
            <div class="card">
                <div class="card-header">
                    <a class="d-block w-100" data-toggle="collapse" href="#leads_inforamtion" aria-expanded="true">
                        <span class="text-lg font-weight-bold"><i class="fa-solid fa-user-plus"></i> LEADS INFORMATION</span>
                    </a>
                </div>
                <div id="leads_inforamtion" class="collapse show" data-parent="#leads_inforamtion">
                    <div class="card-body">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control bg-transparant" name="follow_up_date" value="<?= @$utilitys['data']['follow_up_date'] ?>" required>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control bg-transparant" name="tax_percent" inputmode="decimal" step="0.01" min="0" value="<?= @$utilitys['data_payment']['tax_percent'] ?>" <?= ((!empty($utilitys['data_student']['student_number'])) ? 'readonly' : '') ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-12 row pl-0 pr-0 mr-0">
                            <div class="col-8 pr-0 mr-0">
                                <input type="number" class="form-control bg-transparant" name="advance_amount" placeholder="Enter amount (INR)" inputmode="decimal" step="0.01" min="0" title="Enter amount in Indian Rupees (numbers only, up to 2 decimals)" value="<?= @$utilitys['data_payment']['advance_amount'] ?>" readonly>
                            </div>
                            <div class="col-4 pr-0 mr-0">
                                <input type="number" class="form-control bg-transparant" name="advance_percent" inputmode="decimal" step="0.01" min="0" value="<?= (empty(@$utilitys['data_payment']['advance_percent'])) ? 30 : @$utilitys['data_payment']['advance_percent']; ?>" <?= ((!empty($utilitys['data_student']['student_number'])) ? 'readonly' : '') ?>>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control bg-transparant" name="due_date" value="<?= @$utilitys['data_payment']['due_date'] ?>" <?= ((!empty($utilitys['data_student']['student_number'])) ? 'readonly' : '') ?>>
