...
class example extends CI_Controller
{
    ...
    public function tb_main()
    {
        ...
        $datas = $this->example_model->test(0, $get_params, 'GET');
    ...
    public function detailed($id = null)
    {
        ...
        $output = $this->example_model->detailed(decryptcst($id), @$input_get['whereclause']);
    ...
    *
    public function create()
    {
        ...
        if (empty($input_post)) {
            ...
            $create = $this->example_model->create_and_edit(null, $input_post);
    ...
    public function edit($id = null)
    {
        ...
        if (empty($input_post)) {
            $detailed = $this->example_model->detailed($id);
            if ($detailed['status']) {
            ...
            $edit = $this->example_model->create_and_edit($id, $input_post);
            sys_error_logs($edit);
    ...
    *
    ...
    public function delete($id)
    {
        ...
        $id = decryptcst($id);
        $detailed = $this->example_model->detailed($id);
        $output = $this->example_model->test($id, @$detailed['data']['row_status'], 'DELETE');
    ...
    public function restore($id)
    {
        ...
        $id = decryptcst($id);
        $output = $this->example_model->restore($id);
